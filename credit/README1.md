...
**Сбалансированное дерево** (_АВЛ-дерево, ЧБ-дерево_) - для каждой вершины $v$ высота $h$ её левого и правого поддеревьев различается не более чем на 1.

![image](https://github.com/mireashik/aood_3sem/assets/49165758/9c4d288f-8a2f-43e4-b735-993775dbed28)

**Идеально сбалансированное** - если все уровни **полностью** заполнены, кроме возможно последнего, кол-во элементов левого и правого деревьев не более чем на 1
...
**Вырожденное дерево (лозы)** - каждый узел имеет 1 сына. Вырожденное бинарное дерево эквивалентно связанному списку
...
### 38. АВЛ-дерево. Его назначение. Структура узла и алгоритм вставки
**АВЛ-дерево** - сбалансированное (но не идеальное) + улучшенное дерево поиска (сбалансированное - для каждой вершины $v$ высота $h$ её левого и правого поддеревьев различается не более чем на 1.)
...
Почувствуйте разницу между **деревом поиска** (где k > правое, < левое) по ЗНАЧЕНИЯМ, и **АВЛ-дерево** где всё-тоже самое + сбалансированность:

![image](https://github.com/mireashik/aood_3sem/assets/49165758/08d11635-f4dd-4de7-9de1-841f1dbcf059)

Вставка нового ключа в АВЛ-дерево выполняется, по большому счету, **так же, как это делается в простых деревьях поиска**:
<br>
спускаемся вниз по дереву, выбирая правое или левое направление движения в зависимости от $a < k < b$ и вставляемого ключа. Единственное отличие заключается в том, что при **возвращении** из рекурсии (т.е. после того, как ключ вставлен либо в правое, либо в левое поддерево, и это дерево сбалансировано) выполняется **балансировка** текущего узла.

### 36. АВЛ-дерево. Алгоритм удаления узла из дерева
С удалением узлов из АВЛ-дерева, к сожалению, все не так шоколадно, как с рандомизированными деревьями поиска.

Идея следующая: находим узел $p$ с ключом $k$, в **правом** поддереве находим узел $min$ с наименьшим ключом и заменяем удаляемый узел $p$ на найденный узел $min$

![image](https://github.com/mireashik/aood_3sem/assets/49165758/763f7bd1-4f36-41e4-b119-7df27bcdde3d)

### 37. АВЛ-дерево. Алгоритм двойного поворота.
...
![image](https://github.com/mireashik/aood_3sem/assets/49165758/405fbeb4-13ed-4c81-88b0-c1c4716b7509)

![image](https://github.com/mireashik/aood_3sem/assets/49165758/fec9912a-51b3-4011-b6fd-866453bfb8e4)

![image](https://github.com/mireashik/aood_3sem/assets/49165758/8918ccda-be7c-4f3c-b2a2-3be4a6797e02)
...
![image](https://github.com/mireashik/aood_3sem/assets/49165758/3d5e78f6-8d0a-432d-b95c-115b38be6daf)

![image](https://github.com/mireashik/aood_3sem/assets/49165758/49e6eddd-c4a0-4d59-9bb3-6b5fc917763c)

![image](https://github.com/mireashik/aood_3sem/assets/49165758/e8d55f48-b13f-42ab-b44e-f2b320d4dbbd)
